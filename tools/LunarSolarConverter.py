...
class LunarSolarConverter:
    ...
    def LunarToSolar(self, lunar):
        ...
        solar =  vars(SolarFromInt(SolarToInt(y, m, d) + offset - 1))
        day = solar['solarDay']
    ...
    def SolarToLunar(self, solar):
        ...
        return lunar.isleap,lunar.lunarYear,lunar.lunarMonth,lunar.lunarDay
...
if __name__ == '__main__':
    ...
    lunar = Lunar(2018, 4, 16, isleap= is_leap_year(2018))
    pprint(vars(lunar))
    year,month,day = converter.LunarToSolar(lunar)
